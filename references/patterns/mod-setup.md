...
- **File encoding**: ALL game files (.txt, .yml, .gui) must be UTF-8 with BOM — not just localization. The game logs warnings for files without BOM and may fail to parse them
